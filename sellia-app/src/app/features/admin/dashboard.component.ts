  ...
  template: `
    <div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div *ngFor="let module of modules" class="bg-white rounded-lg p-6 border border-slate-200 shadow-sm hover:shadow-lg transition-all duration-200 cursor-pointer hover:border-primary">
