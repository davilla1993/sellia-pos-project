#!/bin/bash
# ================================================
# Script de test du Rate Limiting - Sellia Backend
# ================================================
# Ce script teste le rate limiting sur /api/auth/login
# Configuration actuelle: 4 tentatives max / 3 minutes
# ================================================
...
echo ""
echo "Pour retester, attendez 3 minutes ou redémarrez le serveur."
echo "================================================"
